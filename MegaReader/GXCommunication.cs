...
namespace MegaReader
{
	class GXCommunicatation
	{
		...
		public void UpdateManufactureSettings(string id)
		{
			...
			{
				throw new Exception("Fabricante desconocido");
			}
		}
		...
		void InitSerial()
		{
			...
			if (Media != null && InitializeIEC)
			{
				...
				string manufactureID = p.Reply.Substring(1, 3); /////Aquí hay que trabajar
		...
		public void InitializeConnection(String man)
		{
			//Manufacturer = man;
			UpdateManufactureSettings(man);
